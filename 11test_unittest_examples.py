...
class TestPostApi(unittest.TestCase):
    ...
    @unittest.skip('Bug - #345345') # пропуск теста
...
class TestIndependent(unittest.TestCase): # тесты для которых не нужны доп.условия
    @unittest.skipIf(sys.platform == 'darwin', 'Not for linux run') # пропустить тест если система = дарвин
